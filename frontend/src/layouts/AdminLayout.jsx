...
import { FiHome, FiBox, FiPlusCircle, FiLogOut, FiShoppingBag, FiHeart, FiGrid, FiUsers } from 'react-icons/fi';
    ...
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <aside className="w-64 bg-gray-800 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/admin/users" className="flex items-center gap-3 p-3 rounded hover:bg-gray-700 transition">
            <FiUsers /> Users
          </Link>
