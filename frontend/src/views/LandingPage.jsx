      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 mt-6">
        ...
        >
          ...
          <div className="text-white p-10 md:p-16 lg:p-20 flex-1 flex flex-col justify-center items-start relative z-20 md:w-[45%] pointer-events-auto text-left">
            ...
            >
              <Link href="/products" className="bg-blue-600 text-white font-bold px-8 py-4 rounded-full hover:bg-blue-500 transition-all hover:scale-105 hover:shadow-xl hover:shadow-blue-600/30 flex items-center gap-2">
                Explore Shop <FiArrowRight className="w-5 h-5" />
              </Link>
              
              <Link href="/visual-search" className="bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold px-8 py-4 rounded-full hover:bg-white/20 transition-all shadow-sm flex items-center gap-2">
