  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center flex-col">
        ...
        <Link href="/products" className="text-orange-500 hover:underline">Return to Products</Link>
      </div>
    );
  }
              ...
              <div className="w-full lg:w-1/3">
                {isAuthenticated ? (
                  ...
                  <div className="bg-blue-50 p-6 rounded-2xl text-blue-800 font-medium text-center flex flex-col items-center gap-4 border border-blue-100">
                    ...
                    <Link href="/login" className="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold shadow-md hover:bg-blue-700 transition-colors w-full">Log In</Link>
                  </div>
                )}
              </div>
            </div>
